...
public class SpherePlayer  {
    ...
    private static class Demuxer {
        ...
        public void open(String url, SpherePlayer.Demuxer.Callback callback) throws IOException {
        ...
        private native int openInput(long pointer, String url, SpherePlayer.Demuxer.Callback callback);
