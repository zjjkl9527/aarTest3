...
public class SphereSurfaceView extends GLSurfaceView {
    ...
    private void init(){
        ...
        super.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                    ...
                    case 2:
                        switch (event.getAction() & MotionEvent.ACTION_MASK) {
                            case MotionEvent.ACTION_POINTER_DOWN: {
                                ...
                                lastDistance = (float) Math.pow((deltaX * deltaX + deltaY * deltaY), 0.5);
                            }
                            break;
                ...
                if(mOnTouchListener != null) return mOnTouchListener.onTouch(v, event);
                return true;
            }
        });
    }
    ...
    class SphereRenderer implements Renderer {
